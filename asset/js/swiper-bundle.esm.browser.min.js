	...
	const o = t > i ? "next" : "prev",
		...
		c = () => {
			...
			if (d(u, t) && (u = t), e.wrapperEl.scrollTo({
					[s]: u
				}), d(u, t)) return e.wrapperEl.style.scrollSnapType = "", void a.cancelAnimationFrame(e.cssModeFrameID);
...
class Swiper {
	constructor(...e) {
		...
		}), a.browser = getBrowser(), a.eventsListeners = {}, a.eventsAnyListeners = [], void 0 === a.modules && (a.modules = []), s.modules && Array.isArray(s.modules) && a.modules.push(...s.modules);
		const i = {};
		a.modules.forEach((e => {
			e({
				swiper: a,
	...
	static installModule(e) {
		...
		const t = Swiper.prototype.modules;
...
function createElementIfNotDefined(e, t, s, a) {
	...
	return e.params.createElements && Object.keys(a).forEach((r => {
		if (!s[r] && !0 === s.auto) {
			...
			n.className = a[r], e.$el.append(n), s[r] = n, t[r] = n
		}
	})), s
}
...
function Parallax({
	...
	const a = (t, s) => {
			const {
				rtl: a
			} = e, i = $(t), r = a ? -1 : 1, n = i.attr("data-swiper-parallax") || "0";
...
function Lazy({
	...
	function l() {
		const {
			...
			slides: a,
			activeIndex: i
		} = e, l = e.virtual && s.virtual.enabled, o = s.lazy;
...
function A11y({
	...
	const f = (e, t, s) => {
		r(e), "BUTTON" !== e[0].tagName && (l(e, "button"), e.on("keydown", u)), d(e, s),
			function(e, t) {
	...
	effectInit({
		...
		setTranslate: () => {
			const {
				...
				size: l,
				browser: o
			} = e, d = e.params.cubeEffect, c = e.isHorizontal(), p = e.virtual && e.params.virtual.enabled;
			let u, h = 0;
